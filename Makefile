...
.PHONY: validate
validate: manifests generate fmt vet setup-envtest ## Run the documented validation flow.
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name miniziti-operator-builder
	$(CONTAINER_TOOL) buildx use miniziti-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm miniziti-operator-builder
	rm Dockerfile.cross
